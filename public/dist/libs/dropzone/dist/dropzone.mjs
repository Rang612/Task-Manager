...
let $4ca367182776f80b$var$defaultOptions = {
   ...
   * This can be useful if you need some additional homepage.blade.php input before sending
   ...
   */ dictRemoveFile: "Remove file",
    /**
   * If this is not null, then the homepage.blade.php will be prompted before removing a file.
   ...
   */ previewTemplate: (/*@__PURE__*/$parcel$interopDefault($fd6031f88dce2e32$exports)),
   ...
   the homepage.blade.php interface specific stuff. Overwriting them won't break the upload
...
class $3ed269f2f0fb224b$export$2e2bcd8739ae039 extends $4040acfd8584338d$export$2e2bcd8739ae039 {
    ...
    // Can be called by the homepage.blade.php to remove a file
    removeFile(file) {
    ...
    _uploadData(files, dataBlocks) {
        ...
        if (this.options.binaryBody) {
            ...
            // Let the homepage.blade.php add additional data if necessary
...
// Asks the homepage.blade.php the question and calls accepted or rejected accordingly
//
