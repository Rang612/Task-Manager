    ...
    <div class="page-header d-print-none">
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <h2 class="page-title">
                        <a href="{{route('user.tasklist')}}">Task List</a>><a>Add Task</a>
                    </h2>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-xl-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="Input Title/ Name Task">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Deadline</label>
                            <div class="input-icon mb-2">
                                <input class="form-control " placeholder="Select a date" id="deadline" name="deadline" value="2024-06-20"/>
                ...
                <div class="row">
                    <div class="col-md-6 col-xl-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="discription" id="discription" placeholder="Input Description">
                        </div>
                        <div class="mb-3">
